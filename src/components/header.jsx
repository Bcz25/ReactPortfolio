...
function Header() {
    return (
      <header className="flex header flex-col justify-between items-start py-5 px-5 relative isolate overflow-auto bg-gray-700 sm:py-8 bg-cover bg-center before:absolute before:inset-0 before:bg-gray-900 before:opacity-30 before:z-0">
